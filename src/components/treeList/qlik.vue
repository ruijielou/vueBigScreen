<template>
    <div class="menuList-item QlikSense-list">
        <div class="tools-tree">
            <div v-if="httpData.qlikData.qlikFirstData == null">loading
                <span v-bind="loadingText" class="iconfont icons-loading"></span>
            </div>
            <div v-for="(qlikIndex, qlik) in httpData.qlikData.qlikFirstData" class="tools-item">
